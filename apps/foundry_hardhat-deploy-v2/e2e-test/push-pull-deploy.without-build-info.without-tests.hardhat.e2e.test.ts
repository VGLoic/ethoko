...
const outputArtifactsPath = `${E2E_FOLDER_PATH}/out-2026-hardhat-plugin-forge-default`;
...
foundryDescribe({
  ...
  build: {
    command: `forge build --skip test --skip script --out ${outputArtifactsPath} --cache-path ${outputArtifactsPath}-cache`,
    outputArtifactsPath,
  },
  runner: "hardhat",
});
